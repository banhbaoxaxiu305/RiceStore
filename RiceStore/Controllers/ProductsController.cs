...
namespace RiceStore.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProID,ProName,ProImage,NameDecription," +
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProID,ProName,ProImage,NameDecription," +
            "CreatedDate, UploadImage")] Product product)
        {
            if (ModelState.IsValid)
            {
